...
async function main() {
  ...
  await contract.connect(from1).regComp("from1", "fist comp of day", amount);
  await contract.connect(from2).regComp("from2", "second comp of day", amount);
  await contract
    .connect(from3)
    .regComp("from3", "Very nice information", amount);
